import QtQuick
// in QML file : we connect the signals to the slots defined in the Bridge class
...
ApplicationWindow {
    ...
    GridLayout {
        ...
        columns: 2
        rows: 3
        anchors.fill: parent //  this makes it resize with the window
        Layout.fillWidth: true //Layout.preferredWidth: 400
